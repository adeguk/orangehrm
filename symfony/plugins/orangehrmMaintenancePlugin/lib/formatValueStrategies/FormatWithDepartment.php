...
/**
 * Class FormatWithDepartment
 */
class FormatWithDepartment implements ValueFormatter
{
    ...
    {
        $value = $this->getDepartmentService()->getDepartmentById($entityValue)->getName();
        return $value;
    }

    /**
     * @return DepartmentService|null
     */
