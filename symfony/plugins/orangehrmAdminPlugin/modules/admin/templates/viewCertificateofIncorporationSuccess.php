...
<div id="certificate" class="box">
    <div class="head"><h1 id="taxHeading"><?php echo __("Certificate of Incorporation"); ?></h1></div>
...
<div id="certificatelist" class="box">
    ...
    <div class="head"><h1 id="taxHeading"><?php echo __("Incorporation Certificates"); ?></h1></div>
    ...
    <div class="inner">
        ...
        <div id="tableWrapper">
            <table class="table hover" id="resultTable">
                ...
                <?php
                $connection = connect();
                $query = "SELECT c.id,c.name,c.file_name,c.extension,c.description,c.status,c.date_added,c.date_modified,e.emp_firstname,e.emp_lastname FROM ohrm_certificates c LEFT JOIN hs_hr_employee e ON c.perform_by = e.emp_number WHERE c.id <> 0 AND c.file_name LIKE '%incorp%' OR c.description LIKE '%incorporation%' OR c.name LIKE '%incorporation%' ";
                ...
                while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                    ...
                    <tr id="edit" class=" <?php echo (($num%2 == 0) ? 'even' : 'odd');?>">
                        ...
                        <td class="left" ><?php echo (($row['file_name']) !="" ? '<img title="Right Click And Click Save As For Download" width="60" height="60" src="../../../../services/certificate/fileView.php?id='.$row["id"].'"' : '');?></td>
...
<script type="text/javascript">
        ...
        $('tr .left').on('click',function(){
            ...
            for(var i = 0; i< table.rows.length; i++) {
                table.rows[i].onclick = function () {
                    ...
                    document.getElementById("preview").src = "../../"+destination+this.cells[3].innerHTML;
    ...
    function Validation() {
        ...
        var status = document.forms["frmDeduct"]["certificate_status"];
