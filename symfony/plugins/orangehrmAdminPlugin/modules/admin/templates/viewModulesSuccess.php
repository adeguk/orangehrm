        ...
        <form name="frmSave" id="frmSave" method="post" action="<?php echo url_for('admin/viewModules'); ?>">
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li class="checkbox">
                        <?php echo $form['salary']->renderLabel(__('Enable Salary module')); ?>
                        <?php echo $form['salary']->render(); ?>
                    </li>
                    <li class="checkbox">
                        <?php echo $form['report']->renderLabel(__('Enable Report module')); ?>
                        <?php echo $form['report']->render(); ?>
                    </li>
                    <li class="required">
