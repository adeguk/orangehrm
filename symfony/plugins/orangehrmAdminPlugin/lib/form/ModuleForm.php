...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'salary' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
            'report' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
        ...
        $this->setValidators(array(
            ...
            'salary' => new sfValidatorPass(),
            'report' => new sfValidatorPass()
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'recruitment', 'salary','report','performance', 'directory', 'maintenance');
