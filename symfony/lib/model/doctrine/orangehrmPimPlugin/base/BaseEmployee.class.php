 ...
 * @method timestamp                 getPurgedAt()                   Returns the current record's "purged_at" value
 ...
 * @method Employee                  setPurgedAt()                   Sets the current record's "purged_at" value
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('emp_mothername as motherName', 'string', 100, array(
            'type' => 'string',
            'default' => '',
            'notnull' => true,
            'length' => 100,
        ...
        $this->hasColumn('emp_deduction as deduction', 'string', 100, array(
            'type' => 'string',
            'default' => '',
            'notnull' => true,
            'length' => 100,
        ));
        $this->hasColumn('emp_other_name as otherName', 'string', 100, array(
            'type' => 'string',
            'default' => '',
            'notnull' => true,
            'length' => 100,
        ));
        $this->hasColumn('emp_other_amount as otherAmount', 'string', 100, array(
            'type' => 'string',
            'default' => '',
            'notnull' => true,
            'length' => 100,
        ));
        $this->hasColumn('emp_ntn as ntn', 'string', 100, array(
            'type' => 'string',
            'default' => '',
            'notnull' => true,
            'length' => 100,
